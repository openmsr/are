...
###############################################################################
## inputs
h5m_out_filepath = 'h5m_files/ARE_gamma.h5m'
...
cad_to_h5m(h5m_filename= 'h5m_files/ARE_gamma_3.h5m',
            ...
            files_with_tags=[{"material_tag": "inconel",
                            ...
                            {"material_tag": "blanket",
                             "cad_filename": "reactor_parts/blanket.step",
                             "transforms":{'scale':scale}},
                            {"material_tag": "iron",
                             "cad_filename": "reactor_parts/shield.step",
                             "transforms":{'scale':scale}},
                            {"material_tag": "air",
                             "cad_filename": "reactor_parts/filter.step",
                             "transforms":{'scale':scale}},
                            ],
