...
#fuel salt
NaF = openmc.Material(name='NaF',temperature=977.5944)
NaF.add_element('Na',1.0)
NaF.add_element('F',1.0)
NaF.set_density('g/cm3',2.56)

ZrF = openmc.Material(name='ZrF',temperature=977.5944)
ZrF.add_element('Zr',1.0)
ZrF.add_element('F',4.0)
ZrF.set_density('g/cm3',4.43)

UF = openmc.Material(name='UF',temperature=977.5944)
...
salt.set_density('g/cm3',3.142866708)
salt.temperature = 977.5944
