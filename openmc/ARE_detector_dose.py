...
energy_p, dose_p = openmc.data.dose_coefficients(particle='photon', geometry='AP')
energy_n, dose_n = openmc.data.dose_coefficients(particle='neutron', geometry='AP')
dose_filter_p = openmc.EnergyFunctionFilter(energy_p, dose_p)
dose_filter_n = openmc.EnergyFunctionFilter(energy_n, dose_n)
tally_p = openmc.Tally(name="photon_energy_dose_cell")
tally_n = openmc.Tally(name="neutron_energy_dose_cell")
tally_p.scores = ['flux']
tally_n.scores = ['flux']
tally_p.filters = [mesh_filter,PhotonParticleFilter,dose_filter_p]
tally_n.filters = [mesh_filter,NeutronParticleFilter,dose_filter_n]
#tally_p.estimator = "tracklength"
#tally_n.estimator = "tracklength"
#Fission rate and neutrons production rate tallies
#tally_fr = openmc.Tally(name="fission_rate") #Total fission reaction rate [fission/source]
#tally_pr = openmc.Tally(name="nu_fission") # Total production of neutrons due to fission [neutrons/source]
tally_hr = openmc.Tally(name="heating")
#tally_fr.scores = ['fission']
#tally_pr.scores = ['nu-fission']
tally_hr.scores = ['heating']
#tally_hr.filter = [mesh_filter]
#Append tallies
tallies = openmc.Tallies()
tallies.append(tally_p)
tallies.append(tally_n)
#tallies.append(tally_fr)
#tallies.append(tally_pr)
