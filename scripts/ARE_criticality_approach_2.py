...
from make_salt import make_are_fuel
...
h5m_filepath = os.getcwd() + '/h5m_files/ARE_pos_0..h5m'
...
na_wp = [11.01,11.03,11.05,11.06,11.08,11.09,11.10,11.11,11.12,11.12,11.13]
...
for f in fuel_comps:
    model = build_model(h5m_filepath,f,nuclear_data_path,batches=120,inactive=20)
