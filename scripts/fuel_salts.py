...
salt1.add_element('Zr',43.60*(1.0-h),percent_type='wo')
salt1.add_element('Hf',43.60*(h),percent_type='wo')
...
salt2.add_element('Zr',43.02*(1.0-h),percent_type='wo')
salt2.add_element('Hf',43.02*(h),percent_type='wo')
...
salt3.add_element('Zr',42.56*(1.0-h),percent_type='wo')
salt3.add_element('Hf',42.56*(h),percent_type='wo')
...
salt4.add_element('Zr',42.03*(1.0-h),percent_type='wo')
salt4.add_element('Hf',42.03*(h),percent_type='wo')
...
salt5.add_element('Zr',41.53*(1.0-h),percent_type='wo')
salt5.add_element('Hf',41.53*(h),percent_type='wo')
...
salt6.add_element('Zr',41.07*(1.0-h),percent_type='wo')
salt6.add_element('Hf',41.07*(h),percent_type='wo')
...
salt7.add_element('Zr',40.64*(1.0-h),percent_type='wo')
salt7.add_element('Hf',40.64*(h),percent_type='wo')
...
salt8.add_element('Zr',40.39*(1.0-h),percent_type='wo')
salt8.add_element('Hf',40.39*(h),percent_type='wo')
...
salt9.add_element('Zr',40.25*(1.0-h),percent_type='wo')
salt9.add_element('Hf',40.25*(h),percent_type='wo')
...
salt10.add_element('Zr',40.06*(1.0-h),percent_type='wo')
salt10.add_element('Hf',40.06*(h),percent_type='wo')
...
salt11.add_element('Zr',39.88*(1.0-h),percent_type='wo')
salt11.add_element('Hf',39.88*(h),percent_type='wo')
...
salt12.add_element('Zr',39.75*(1.0-h),percent_type='wo')
salt12.add_element('Hf',39.75*(h),percent_type='wo')
